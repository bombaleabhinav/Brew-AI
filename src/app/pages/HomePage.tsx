    ...
    <div className="min-h-screen bg-neutral-50">
      ...
      <section className="pt-32 pb-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <h1 className="text-6xl tracking-tight text-neutral-900 mb-6 flex items-center justify-center gap-4">
            ...
            <p className="text-lg text-neutral-600 max-w-2xl mx-auto">
              <img src="/media/logo.png" alt="Brew Logo" className="w-4 h-4 inline-block mr-1" /> Brew helps hackathon teams evaluate ideas and team composition using multi-perspective AI judges.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-20 px-6">
        <div className="max-w-6xl mx-auto">
          <motion.div
            ...
            transition={{ duration: 0.6 }}
          >
            <h2 className="text-3xl text-neutral-900 mb-12 text-center flex items-center justify-center gap-3">
              What Brew does?
            </h2>
      ...
      <footer className="py-8 px-6 border-t border-neutral-200">
        <div className="max-w-7xl mx-auto text-center text-sm text-neutral-600 flex items-center justify-center gap-2">
          © 2026 <img src="/media/logo.png" alt="Brew Logo" className="w-4 h-4 inline-block" /> Brew. All rights reserved.
        </div>
      </footer>
    </div>
  );
