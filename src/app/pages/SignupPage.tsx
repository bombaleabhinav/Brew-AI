    ...
    <div className="min-h-screen bg-neutral-50 flex items-center justify-center px-6 py-12">
      ...
      >
        <div className="text-center mb-8">
          <Link to="/" className="text-3xl tracking-tight text-neutral-900 flex items-center justify-center gap-2">
            <img src="/media/logo.png" alt="Brew Logo" className="w-10 h-10" />
            Brew
          </Link>
